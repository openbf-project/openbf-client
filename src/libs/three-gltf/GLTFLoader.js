...
let GLTFLoader = (function () {
  ...
  GLTFMaterialsClearcoatExtension.prototype.extendMaterialParams = function (materialIndex, materialParams) {
    ...
    let materialDef = parser.json.materials[materialIndex];
  ...
  GLTFTextureBasisUExtension.prototype.loadTexture = function (textureIndex) {
    ...
    let source = json.images[extension.source];
    let loader = parser.options.ktx2Loader;
  ...
  GLTFParser.prototype.loadAccessor = function (accessorIndex) {
    ...
    return Promise.all(pendingBufferViews).then(function (bufferViews) {
      ...
      if (byteStride && byteStride !== itemBytes) {
        ...
        let ibCacheKey = 'InterleavedBuffer:' + accessorDef.bufferView + ':' + accessorDef.componentType + ':' + ibSlice + ':' + accessorDef.count;
  ...
  GLTFParser.prototype.loadTextureImage = function (textureIndex, source, loader) {
    ...
    let URL = self.URL || self.webkitURL;
  ...
  GLTFParser.prototype.loadMesh = function (meshIndex) {
    ...
    return Promise.all(pending).then(function (results) {
      ...
      let geometries = results[results.length - 1];
  ...
  GLTFParser.prototype.loadAnimation = function (animationIndex) {
    ...
    return Promise.all([
      ...
      for (let i = 0, il = nodes.length; i < il; i++) {
        ...
        let interpolation = sampler.interpolation !== undefined ? INTERPOLATION[sampler.interpolation] : InterpolateLinear;
  ...
  GLTFParser.prototype.loadNode = function (nodeIndex) {
    ...
    return (function () {
      ...
      if (nodeDef.extensions
        ...
        let lightIndex = nodeDef.extensions[EXTENSIONS.KHR_LIGHTS_PUNCTUAL].light;
